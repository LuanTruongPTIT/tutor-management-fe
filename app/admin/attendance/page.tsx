              ...
              <div className="flex items-center">
                ...
                <div className="flex flex-col">
                  <span className="ml-2 font-bold text-black">
                    {props.title ? props.title : "Match class teacher Luan"}
                  </span>
                  <span className="ml-2 text-sm text-gray-500">Have Join.</span>
                </div>
              </div>
              <div className="flex items-center">
            ...
            <div className="m-auto block">
              <div>
                <span className="inline-block text-sm text-gray-500">
                  Process :<span className="font-bold text-gray-700">25</span>
                  /50
                </span>
              </div>
        ...
        <div className="mb-4">
          <div className="w-full rounded-2xl bg-white p-4 shadow-lg">
            ...
            <div className="m-auto block">
              <div>
                <span className="inline-block text-sm text-gray-500">
                  Process :<span className="font-bold text-gray-700">50</span>
                  /50
                </span>
              </div>
              <div className="mt-2 h-2 w-full rounded-full bg-gray-200">
        ...
        <div className="mb-4 sm:ml-4 xl:mr-4">
          <div className="w-full rounded-2xl bg-white shadow-lg">
            <div className="flex items-center justify-between p-4">
              <p className="font-bold text-black">Room 1</p>
