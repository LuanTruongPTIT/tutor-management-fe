...
const tabs = [
  {
    ...
    description: "Xây dựng kiến thức nền tảng.",
    more: (
  ...
  },
  {
    ...
    name: "Học tập",
    description: "Bổ sung kiến thức nâng cao.",
    more: (
...

  {
    ...
    name: "Ôn Luyện",
    description: "Luyện đề thực chiến",
    more: (
  ...
  },
  {
    ...
    name: "Về đích",
    description: "Thi thử và làm đề ngẫu nhiên.",
    more: (
  ...
  text-5xl
      ...
      <p
        className="
            ...
            "
      >
        Học tập hiệu quả, vươn tới tương lai. Với gia sư trực tuyến, thành công
        trong tầm tay.
      </p>
        ...
        <Link href="/">
          <Button className="py-1 ">
            <div className="flex items-center justify-center">
              <div className="text-lg">Bắt đầu với Preply miễn</div>
              <div>
