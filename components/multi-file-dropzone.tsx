      ...
      <div>
        <div className="flex flex-col gap-2">
          ...
          {value?.map(({ file, progress }, i) => (
            <div
              key={i}
              className="flex h-16 w-96 flex-col justify-center rounded border border-solid border-black/100 px-4 py-2"
            >
              <div className="flex items-center gap-2 text-black">
                <FileIcon size="30" className="shrink-0" />
                <div className="min-w-0 text-sm">
                  <div className="text-black  overflow-hidden overflow-ellipsis whitespace-nowrap">
                    {file.name}
                  </div>
